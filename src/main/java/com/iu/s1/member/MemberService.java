...
//      authorities.add(new SimpleGrantedAuthority(Role.MEMBER.getName()));
      ...
      System.out.println("Enabled : "+memberVO.getEnabled());
		return  memberVO;//;new User(memberVO.getUsername(), memberVO.getPassword(), memberVO.getEnabled(), true, true, true, authorities);
	}
